...
namespace Commander
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAutoMapper(typeof(Startup));// Same.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());

           // services.AddScoped<ICommanderRepository, MockCommanderRepository>();
            services.AddScoped<ICommanderRepository, SqlCommanderRespository>();
        }
